...
describe("DB Test | Reading a question", () => {
	//Creates a new question to database, which we can read later.

	it("DB Test | Search question by question-string", done => {
		//actual test
	...
	it("DB Test | Search question that can't be found, shouldn't return anything", done => {
		//actual test
